      ...
      <v-form>
        <v-container class="py-0">
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field label="姓(カナ)" />
            </v-col>

            <v-col cols="12" md="6">
              <v-text-field label="名(カナ)" />
            </v-col>

            <v-col cols="12" md="4">
              <v-text-field label="役職" />
            </v-col>
            ...
            <v-col cols="12" md="4">
              ...
              >
                <template v-slot:activator="{ on }">
                  <v-text-field v-model="date.birth" label="誕生日" readonly v-on="on"></v-text-field>
                </template>
            ...
            <v-col cols="12" class="text-right">
              <v-btn :to="{ name: 'Employee Profile'}" @click="updateProfile" color="success">更新確定</v-btn>
            </v-col>
          </v-row>
        </v-container>
      </v-form>
