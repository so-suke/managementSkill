  ...
  <div class="skillAppend">
    <div class="skillAppend--form">
      <skill-base-select
        ...
        :rules="skillRules"
        :items="skills"
        :whatSelectJp="skillKind.jp"
      ></skill-base-select>

      <skill-base-select
        ref="formColumnExperiencePeriods"
...
export default class SkillForm extends Vue {
  ...
  @Prop() private skillKind!: { en: string; jp: string };
  ...
  public getSelectIdSet(): { skillId: string; experiencePeriodId: string } {
    return {
      skillId: (this.$refs.formColumnSkill as SkillBaseSelect).getSelectId(),
      experiencePeriodId: (this.$refs
        .formColumnExperiencePeriods as SkillBaseSelect).getSelectId()
    };
  }
}
</script>
